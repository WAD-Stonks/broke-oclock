...
`@broke-oclock/contracts/rpc` exports the shared batch cap separately so browser transport setup does not import Zod response schemas. Router/procedure definitions remain in apps/api, with AppRouter inferred directly by the web client.
